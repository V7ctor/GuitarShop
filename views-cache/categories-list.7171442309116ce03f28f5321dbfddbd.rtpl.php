<?php if(!class_exists('Rain\Tpl')){exit;}?><section class="section-products">
    <h1 class="section-title">Confira os instrumentos da categoria <?php echo htmlspecialchars( $category["namecategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h1>
    <div class="container-products">
        <?php $counter1=-1;  if( isset($productscategory) && ( is_array($productscategory) || $productscategory instanceof Traversable ) && sizeof($productscategory) ) foreach( $productscategory as $key1 => $value1 ){ $counter1++; ?>
