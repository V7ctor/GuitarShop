<?php if(!class_exists('Rain\Tpl')){exit;}?><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <input type="hidden" name="business" value="financeiro@guitarshop.com.br">

    <?php $counter1=-1;  if( isset($products) && ( is_array($products) || $products instanceof Traversable ) && sizeof($products) ) foreach( $products as $key1 => $value1 ){ $counter1++; ?>
    <input type="hidden" name="item_name_<?php echo htmlspecialchars( $counter1+1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" value="<?php echo htmlspecialchars( $value1["nameproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
    ...
    <input type="hidden" name="email" value="<?php echo htmlspecialchars( $order["emailuser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
