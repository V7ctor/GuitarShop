            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Seja bem vindo à loja guitarShop</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Seja Bem vindo ao site GuitarShop, para habilitar ou desabilitar envio de emails 
                              vá até seu perfil e clique em configurações.
                              Caso habilite essa função, você será notificado em futuras promoções
                            </td>
                          </tr>
                          <tr>
                            <td class="body-text-cell">
                                Leia os <a href="#">Termos de Serviço</a> e também as <a href="#">Regras do site</a>,
                                Saiba mais <a href="#">Sobre Nós</a> e esteja ciente de nossas <a href="#">Políticas de Devoluções</a>
                                e <a href="#">Processos de Entregas</a>.
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
                        ...
                        <![endif]--><a href="www.guitarshop.com.br"
                        style="background-color:#6f6896;border:1px solid #645e85;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;line-height:38px;text-align:center;text-decoration:none;width:230px;-webkit-text-size-adjust:none;mso-hide:all;">Acessar Loja GuitarShop</a></div>
